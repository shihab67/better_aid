...
<header id="topnav" class="defaultscroll sticky" style="z-index: 1000">
    <div class="container-fluid d-flex justify-content-between align-items-center header">
        ...
        <!-- End Logo container-->
        <div class="d-flex justify-content-between align-items-center" style="order: 2; padding-left: 10px; padding-right: 10px;">
        ...
        <div id="navigation">
            ...
            <ul class="navigation-menu">
                ...
                <li><a href="/doctor" class="sub-menu-item">Dashboard</a></li>

                <li class="has-submenu parent-menu-item">
                    <a href="javascript:void(0)">Appointments</a><span class="menu-arrow"></span>
                    <ul class="submenu">
                        <li><a href="/todays-appointments" class="sub-menu-item">Today's Appointments</a></li>
                        <li><a href="/upcoming-appointments" class="sub-menu-item">Upcoming Appointments</a></li>
                        <li><a href="/previous-appointments" class="sub-menu-item">Previous Appointments</a></li>
                    </ul>
                </li>

                <li><a href="/payment-history" class="sub-menu-item">Payment History</a></li>

                <li><a href="/patient-list" class="sub-menu-item">Patient List</a></li>

                <li><a href="/settings" class="sub-menu-item">Settings</a></li>
